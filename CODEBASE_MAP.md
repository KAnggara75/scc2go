...
- **Entry / Key Files**:
  ...
  - [`go.mod`](file:///Users/i/work/KAnggara75/scc2go/go.mod) — Definisi modul Go (Go 1.25.0 / Go 1.26.0) dan dependencies utama.
...
- **Dependencies**:
  - `resty.dev/v3 v3.0.0-rc.4` — HTTP client dengan automatic retry, timeout, dan custom TLS config.
  - `github.com/spf13/viper v1.21.0` — Global configuration registry untuk Go applications.
  - `github.com/rs/zerolog v1.35.1` — Structured JSON/console logging dengan level switching (`InfoLevel` vs `TraceLevel`).
- **Consumers**:
